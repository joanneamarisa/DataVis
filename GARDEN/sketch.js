...
function draw() {
  ...
  let subhead = 'is a visual representation of a mother-daughter conversation. Welcome to this space. Hover anywhere over the garden to see what each element represents!';
  fill(0);
  textFont('garamond', 15);
  text(subhead, 60, 80, 375, 150);
  text('Song: Edelweiss by Irwin Kostal', windowWidth-300, 60);
...
function HoverA(mx, my) {
	...
	if (withinRadius) {
        ...
        text('*Leaves growing to the left represent my text message, and the right symbolise my mothers.', 60, 150);
	} else {textFill = 0;}
